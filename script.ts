...
function initCanvas(): CanvasRenderingContext2D {
	const canvasDOM: HTMLCanvasElement = document.getElementById('canvas') as HTMLCanvasElement;
...
function createRect(pos: Vec2, size: Vec2): Rect {
	return new Rect(pos, size);
}

function createLine(from: Vec2, to: Vec2): Line {
