...
const playerSprite = createRect(new VectorMath.Vec2(0.5, 0.5), new VectorMath.Vec2(0.02, 0.02));
const player = new Player(new VectorMath.Vec2(0.5, 0.5), playerSprite);

const mouseSprite = createRect(player.mousePos, new VectorMath.Vec2(0.02, 0.02));
